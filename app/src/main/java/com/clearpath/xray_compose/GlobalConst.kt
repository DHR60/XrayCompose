...
object GlobalConst {
    ...
    const val geositeDat = "geosite.dat"
    const val geoipDat = "geoip.dat"
    ...
    val defaultTransportNetworkEnum = ETransport.RAW
    ...
    const val defaultGrpcMode = "gun"
    const val multiGrpcMode = "multi"
    val grpcModeList = listOf(
        defaultGrpcMode,
        multiGrpcMode
    )

    const val defaultXhttpMode = "auto"
    val xhttpModeList = listOf(
        "auto",
        "packet-up",
        "stream-up",
        "stream-one",
