...
data class ProfileModel(
    ...
    fun getNetworkType(): ETransport {
        val networkType = enumEntries<ETransport>().firstOrNull { it.value == network }
        return networkType ?: GlobalConst.defaultTransportNetworkEnum
    }

    fun getNetworkName(): String {
        return getNetworkType().value
    }
}
